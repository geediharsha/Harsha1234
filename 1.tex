...
17. Let C be any circle with centre $\brak{0,\sqrt{2}}$. Prove that at the most two rational points can be there on C.\brak {A\ rational\ point\ is\ a\ point\ both\ of\ whose\ coordinates\ are\ rational\ numbers.}\hfill(1997- 5 Marks)\\
...
23. Find the equation of circle touching the line $2x+3y+1=0$ at $\brak{1,-1}$ and cutting orthogonally the circle having line segment joining \brak{0,3} and \brak{-2,-1} as diameter.\hfill(2004- 4 Marks)\\     
